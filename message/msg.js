/*
  * Created by Hell Boy ID 
  * Base Ori : rtwone / Irfan
  * Buy No Enc? wa.me/94770611075
*/
...
module.exports = async(conn, msg, m, setting, store, welcome) => {
	try {
		...
		const isOwner = ownerNumber == sender ? true : ["94770611075@s.whatsapp.net", "94770611075@s.whatsapp.net"].includes(sender) ? true : false
		...
		const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+94770611075` } },
			{ urlButton: { displayText: `Script!`, url : `https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E` } },
